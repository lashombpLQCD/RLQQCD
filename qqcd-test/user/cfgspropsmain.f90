...
!   enddo ! nhit
!-single process mode
  ! rwdir = "/data/whytet/qqcd/submethodsminresdr/scratch1" !BS


  !  rwdir = "/data/lashombp/qqcd/polysub/scratch1/" !PL

  !  rwdir = "/data/lashombp/qqcd/submethodsppminresdr/scratch1/" !PL
  !  rwdir = "/data/lashombp/qqcd/submethodsppminresdr/scratch2/" !PL
  !  rwdir = "/data/lashombp/qqcd/submethodsppminresdr/scratch3/" !PL
  !  rwdir = "/data/lashombp/qqcd/submethodsppminresdr/scratch4/" !PL
  !  rwdir = "/data/lashombp/qqcd/submethodsppminresdr/scratch5/" !PL
  !  rwdir = "/data/lashombp/qqcd/submethodsppminresdr/scratch6/" !PL
  !  rwdir = "/data/lashombp/qqcd/submethodsppminresdr/scratch7/" !PL
  !  rwdir = "/data/lashombp/qqcd/submethodsppminresdr/scratch8/" !PL
  !  rwdir = "/data/lashombp/qqcd/submethodsppminresdr/scratch9/" !PL
  !  rwdir = "/data/lashombp/qqcd/submethodsppminresdr/scratch10/" !PL
  

  !  rwdir = "/data/lashombp/qqcd/polysub_24242432/scratch1/" !PL
  !  rwdir = "/data/lashombp/qqcd/polysub_24242432/scratch2/" !PL
  !  rwdir = "/data/lashombp/qqcd/polysub_24242432/scratch3/" !PL


  !  rwdir = "/data/lashombp/qqcd/preconditioning_4444/scratch1/" !PL
  !  rwdir = "/data/lashombp/qqcd/preconditioning_8888_2/scratch1/" !PL
  !  rwdir = "/data/lashombp/qqcd/preconditioning_12121216/scratch1/" !PL 

  !  rwdir = "/data/lashombp/qqcd/8888_nompi/scratch1/" !PL 

    
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432/scratch1/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432/scratch2/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432/scratch3/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432/scratch4/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432/scratch5/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432/scratch6/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432/scratch7/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432/scratch8/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432/scratch9/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432/scratch10/" !PL 


  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432_main/scratch1/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432_main/scratch2/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432_main/scratch3/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432_main/scratch4/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432_main/scratch5/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432_main/scratch6/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432_main/scratch7/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432_main/scratch8/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432_main/scratch9/" !PL 
  !  rwdir = "/data/lashombp/qqcd/newpolysub24242432_main/scratch10/" !PL 



    !rwdir = "/data/lashombp/qqcd/qqcd_scratch/4444/" !PL 
    !rwdir = "/data/lashombp/qqcd/qqcd_scratch/8888/" !PL 
    !rwdir = "/data/lashombp/qqcd/qqcd_scratch/12121216/" !PL 


    rwdir = "/data/lashombp/qqcd/24242448_configs_TEST/" !PL 


  ! rwdir = "/data/whytet/qqcd/scratch-1/" !TW
  ! rwdir = "/data/whytet/qqcd/scratch-2/" !TW
  ! rwdir = "/data/whytet/qqcd/scratch-3/" !TW
  ! rwdir = "/data/whytet/qqcd/scratch-4/" !TW
  ! rwdir = "/data/whytet/qqcd/scratch-5/" !TW
  ! rwdir = "/data/whytet/qqcd/scratch-6/" !TW
  ! rwdir = "/data/whytet/qqcd/scratch-7/" !TW
  ! rwdir = "/data/whytet/qqcd/scratch-8/" !TW
  ! rwdir = "/data/whytet/qqcd/scratch-9/" !TW
  ! rwdir = "/data/whytet/qqcd/scratch-10/" !TW

    !rwdir = "/data/qcd2/qqcd/scratch/"
    !rwdir = "/data/qcd2/qqcd/scratch8/"
    !rwdir = "/data/qcd2/qqcd/scratch-1570-20000/"
...
!                  new double (SST) propagators.
    newcalc = 2 !changed to 3 to get matlab matrix TW 10/13/17 
    !TW  newcalc = 3
...
! value of xxxxx for the first filename to be read in):
     !BS  cfgfile = "cfgfiles/G00001000qwilson-08-08-b6-new"
    ! cfgfile = "cfgfiles/G00001000qwilson-24-32-b6-new"
    ! cfgfile = "cfgfiles/G00002000qwilson-24-32-b6-new"
    ! cfgfile = "cfgfiles/G00003000qwilson-24-32-b6-new"
    ! cfgfile = "cfgfiles/G00004000qwilson-24-32-b6-new"
    ! cfgfile = "cfgfiles/G00005000qwilson-24-32-b6-new"
    ! cfgfile = "cfgfiles/G00006000qwilson-24-32-b6-new"
    ! cfgfile = "cfgfiles/G00007000qwilson-24-32-b6-new"
    ! cfgfile = "cfgfiles/G00008000qwilson-24-32-b6-new"
    ! cfgfile = "cfgfiles/G00009000qwilson-24-32-b6-new"
    ! cfgfile = "cfgfiles/G00010000qwilson-24-32-b6-new"

     

    ! cfgfile = "cfgfiles/G00001000qwilson-12-16-b6-new"
    ! cfgfile = "cfgfiles/G00001000qwilson-04-04-b6-new"
    ! cfgfile = "cfgfiles/G00001000qwilson-08-08-b6-new" 



     cfgfile = "cfgfiles/G00001000qwilson-24-48-b6" 
...
! of configurations. (7-31-05)
   ...
   !nsweep  = 38000 !TW 4/13/17
   !nsweep  = 20000
   nsweep  = 1 !commented out TW 10/13/17
 
 !BS set nsweep equal to n0sweep +k*n1sweep and newcalc=3 for generating new k+1 configurations 
    n0sweep = 20000
    n1sweep = 2000

    ! only read 1 config, it was already generated
  !BS  nsweep = 1

! Choose the number of pseudo-heatbath hits/site/sweep.
! (The value of nhit is irrelevant unless newcalc=3)G
    nhit = 1
...
!    kappa(1) = 0.165_KR*tad(1)
     ...
     !01/14/2013 (try a very small kappa. It has to be larger than 1/8, say 0.14. 
     !In this case, the perturbative subtraction has to work very well.)

    kappa(1) = 0.1570_KR*tad(1)  !this is the value used in my original test !TW 11/17/20 uncomment here for kappa crit                                       
   !  kappa(1) = 0.15690_KR*tad(1)  !test value!BS  differentiate  kappa(1) & kappa





    ! kappa(2) = 0.0_KR*tad(1) !changed to 0.0 for testing minresdr5EIG - TW 8/4/18          
...
! MASS AVERAGING
  ...
  ! beta=6.0 
    ...
    mtmqcd(1,1:2)  =  (/ 0.1570_KR*tad(1), 0.00001_KR /)!Just for testing,other        
    mtmqcd(2,1:2)  =  (/ 0.15670_KR*tad(1), 0.00001_KR /)!mtmqcd(1,1:2)should be
    mtmqcd(3,1:2)  =  (/ 0.15674_KR*tad(1), 0.00001_KR /)!smaller than mtmqcd(2,
    mtmqcd(4,1:2)  =  (/ 0.1650_KR*tad(1), 0.00001_KR /)!1:2)
...
! Hard code in the strange quark mass for the subroutine discon.
    ...
    kappaloop(1) = 0.1570_KR ! Wilson - Victor Case
    kappaloop(2) = 0.0_KR    ! Wilson - Victor Case
